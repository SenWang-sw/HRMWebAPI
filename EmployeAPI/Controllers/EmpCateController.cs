...
namespace EmployeAPI.Controllers
{
    ...
    [ApiController]
    public class EmpCateController : ControllerBase
    {
        private readonly IEmpCateService s;

        public EmpCateController(IEmpCateService service)
        {
            s = service;
        }
        [HttpGet("get all")]
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert(EmpCate entity)
        {
            return Ok(await s.AddAsync(entity));
        }
        [HttpPost("Update")]
        public async Task<IActionResult> Update(EmpCate entity)
        {
